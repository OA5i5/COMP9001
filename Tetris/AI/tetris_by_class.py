...
Block dictionary structure:
{
    ...
    'move_steps': [step0, step1, ...] (Each step is a string list like 'ADW'), e.g., 'move_steps': ['WWA', 'AAA', 'A', '']
    'cur_step': 0 (Describes offset in move_steps, e.g., move_steps[cur_step] == 'WWA')
}
